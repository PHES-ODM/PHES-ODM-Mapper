...
filtered_data, filtered_files = run_filter(filter_config_file="filter_config_file.csv",
...
filtered_data, _ = run_filter(filter_config_file="filter_config_file.csv",
                              data=data)
```
"""
...
def save_data(
    data: Dict[str, pd.DataFrame], output_data_dir: Union[Path, str]
) -> Dict[str, List[Path]]:
...
def run_filter(
    ...
    *,
    ...
    output_files = {}
    if output_data_dir:
        output_files = save_data(data, output_data_dir)
...
if __name__ == "__main__":
    ...
    d = get_input_data_files(opts.data_files, opts.data_dir)
    run_filter(
