...
# dir1 = "/Users/martinwellman/Documents/Health/Wastewater/PHES-ODM-Mapper/gen/nwss-reporting-to-v2"
# dir2 = "/Users/martinwellman/Documents/Health/Wastewater/PHES-ODM-Mapper/gen/nwss-reporting-to-v2-orig"

# dir1 = "/Users/martinwellman/Documents/Health/Wastewater/PHES-ODM-Mapper/gen/odm-v1-to-v2"
# dir2 = "/Users/martinwellman/Documents/Health/Wastewater/PHES-ODM-Mapper/gen/odm-v1-to-v2-orig"

# dir1 = "/Users/martinwellman/Documents/Health/Wastewater/PHES-ODM-Mapper/gen/odm-wide-to-long"
# dir2 = "/Users/martinwellman/Documents/Health/Wastewater/PHES-ODM-Mapper/gen/odm-wide-to-long-orig"

# dir1 = "/Users/martinwellman/Documents/Health/Wastewater/PHES-ODM-Mapper/gen/odm-wide-to-long-eu"
# dir2 = "/Users/martinwellman/Documents/Health/Wastewater/PHES-ODM-Mapper/gen/odm-wide-to-long-eu-orig"

dir1 = "/Users/martinwellman/Documents/Health/Wastewater/PHES-ODM-Mapper/gen/pha4ge-to-v2"
dir2 = "/Users/martinwellman/Documents/Health/Wastewater/PHES-ODM-Mapper/gen/pha4ge-to-v2-orig"
...
files = []
for file in sorted(set(files1 + files2)):
    file1 = file if file in files1 else None
    file2 = file if file in files2 else None
...
for file1, file2 in files:
    if not file2:
        print(f"*** {file1} exists in first directory but not second")
        has_mismatches = True
        continue
    if not file1:
        print(f"*** {file2} exists in second directory but not first")
        has_mismatches = True
        continue
    ...
    if len(df1) != len(df2):
        print(
            f"*** {file1} != {file2}: Mismatched number of rows ({len(df1)} vs {len(df2)})"
        )
        has_mismatches = True
        continue
    ...
    coords = [(int(y), df1.columns[x]) for y, x in coords]
    if len(coords):
