...
class IDValue:
    def __init__(
        ...
        Args:
            root_id (str | None): The ID value, without the added index. If None then this ID is considered to
                be empty (and will be replaced with a non-empty IDValue object in the future).
            index (int | None, optional): The index to add at the end of the ID, which is added to ensure that primary
        ...
        self._str_value: str | None = None
        self._repr_value: str | None = None
    ...
    def __repr__(self) -> str:
        if self._repr_value is None:
            self._repr_value = (
                f"<{type(self).__name__}:{self!s} object at {hex(id(self))}>"
            )
    ...
    @property
    def unindexed_value(self) -> str | None:
        """Get the unindexed ID value (ie. the value passed as root_id to the constructor)

        Returns:
            str | None: The unindexed ID value, or None if the ID object is empty.
        """
    ...
    def index(self) -> int | None:
        ...
        Returns:
            int | None: The integer index of the ID, or None if the index has not been
                generated.
        """
        return self._index
