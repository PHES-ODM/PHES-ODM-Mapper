...
class DataBindings:
    ...
    def __init__(
        ...
        Args:
            ...
            root_class (str | None): The name of the class that this binding is for. A class name is a table name.
            ...
            sub_class_names (list[str] | None): If root_class is None, then sub_class_names must be set to a list
            ...
            prefix (str | None, Optional): The prefix used to access this data binding. This is for informational
    ...
    def get_first_linked_value(
        self,
        target_slot: str,
        linkage_path: str | dict | list[dict] | None = None,
        ...
        if isinstance(v, float) and not isna(v) and int(v) == v:
            v = int(v)
