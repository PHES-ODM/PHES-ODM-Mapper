...
These LinkML-Map schemas are not usually written by hand. They are typically
generated by
[PHES-ODM-MapGenerator](https://github.com/PHES-ODM/PHES-ODM-MapGenerator),
which produces the mapper YAML files that this repository's modules consume.
The rules below describe what the Mapper expects of those files, whether they
are generated or hand-written.
...
- [generate_ids](generate_ids.md) — the step that links the mapped tables
  together
- [PHES-ODM-MapGenerator](https://github.com/PHES-ODM/PHES-ODM-MapGenerator) —
  generates the LinkML-Map mapper files used by this action
- Implementation:
