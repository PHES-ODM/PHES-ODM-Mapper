...
[/odm_map/data/modules/pha4ge-to-v3/expander/expander_config.yaml](https://github.com/PHES-ODM/PHES-ODM-Mapper/blob/main/odm_map/data/modules/pha4ge-to-v3/expander/expander_config.yaml).
...
- [Reference](../reference.md#module-configuration) — the module
  configuration file
- Implementation:
  [/odm_map/actions/action_expand_data.py](https://github.com/PHES-ODM/PHES-ODM-Mapper/blob/main/odm_map/actions/action_expand_data.py),
  [/odm_map/expander/array_expander.py](https://github.com/PHES-ODM/PHES-ODM-Mapper/blob/main/odm_map/expander/array_expander.py)
