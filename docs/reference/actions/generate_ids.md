...
Two files are needed, both described in full in
[reference/id_generator.md](../id_generator.md).
...
namespaces, helper functions, linkage paths, and code selectors — is in
[reference/id_generator.md](../id_generator.md).
...
- [Pipeline Actions](README.md) — step structure, interpolation variables, and
  path resolution
- [reference/id_generator.md](../id_generator.md) — the complete reference for both ID
  files
